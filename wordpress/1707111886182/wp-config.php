...
define('WP_HOME', 'http://lawfirm.local/wordpress/1707111886182');
define('WP_SITEURL', 'http://lawfirm.local/wordpress/1707111886182');
...
define('WP_PLUGIN_URL', 'http://lawfirm.local/wordpress/1707111886182/wp-content/plugins');
if ( ! defined( 'ABSPATH' ) ) {
